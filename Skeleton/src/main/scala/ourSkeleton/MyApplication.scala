...
import ourSkeleton.Persistance._
...
class MyApplication extends HttpServlet {
  ...
  override def init(config: ServletConfig) {
    ...
    SessionFactory.concreteFactory = Some(() =>
      Session.create(java.sql.DriverManager.getConnection("jdbc:h2:" + System.getProperty("user.dir") + "/test;AUTO_SERVER=TRUE", "sa", "sa"), new H2Adapter))

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////   
    //    									HERE YOU CAN ADD YOU ROUTE
    //    
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
